  ...
  return (
    <div className="container">
      ...
      <div className="search-container">
        ...
        <input type="text" placeholder="Search Pantry & Stable" className="search-bar" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
      </div>

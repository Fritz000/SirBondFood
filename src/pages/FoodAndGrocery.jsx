...
const categories = [
  ...
  { name: "Pantry & Stable", icon: freshbasswithwhitebackground1, path: "/PantryStable" },
  { name: "Meat & Seafood", icon: stunningimpastopaintingwhitehen1, path: "/MeatSeafood" },
  { name: "Dairy & Eggs", icon: dairyeggs, path: "/DairyEggs" },
  { name: "Bakery", icon: foodbasket, path: "/BakeryItems" },
  { name: "Beverages", icon: glassmilkbottlefreshmilk1, path: "/Beverages" },
];

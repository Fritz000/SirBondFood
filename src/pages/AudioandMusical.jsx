  ...
  return (
    <div className="container">
      ...
      <div className="search-container">
        ...
        <input type="text" placeholder="Search Audio & Musical" className="search-bar" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
      </div>
...
export default AudioandMusical;